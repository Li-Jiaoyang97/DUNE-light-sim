...
type=$1
# batch_number=6
output_dir=/pnfs/dune/scratch/users/jiaoyang/build_optical_0411/${type}/*/v09_72_00d00/gen
...
printf '%s\n' $output_dir/*/*_hist*.root | xargs -n 1 basename | cut -d'_' -f 1 > $temp_list_file
