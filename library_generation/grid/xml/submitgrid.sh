...
# xenon
project.py --xml ./xenon_xml/prod_optical_dune_xenon00.xml --stage gen --clean
project.py --xml ./xenon_xml/prod_optical_dune_xenon00.xml --stage gen --submit

project.py --xml ./xenon_xml/prod_optical_dune_xenon01.xml --stage gen --clean
project.py --xml ./xenon_xml/prod_optical_dune_xenon01.xml --stage gen --submit

project.py --xml ./xenon_xml/prod_optical_dune_xenon02.xml --stage gen --clean
project.py --xml ./xenon_xml/prod_optical_dune_xenon02.xml --stage gen --submit

project.py --xml ./xenon_xml/prod_optical_dune_xenon03.xml --stage gen --clean
project.py --xml ./xenon_xml/prod_optical_dune_xenon03.xml --stage gen --submit

project.py --xml ./xenon_xml/prod_optical_dune_xenon04.xml --stage gen --clean
project.py --xml ./xenon_xml/prod_optical_dune_xenon04.xml --stage gen --submit

project.py --xml ./xenon_xml/prod_optical_dune_xenon05.xml --stage gen --clean
project.py --xml ./xenon_xml/prod_optical_dune_xenon05.xml --stage gen --submit